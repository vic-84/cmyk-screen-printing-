...
class PDFPageSelector(QtWidgets.QDialog):
    ...
    def init_ui(self):
        ...
        self.color_mode_combo.addItems([
            "RGB (Color completo)",
            "Escala de grises (Optimizado)"
        ])
        config_layout.addRow("🎨 Modo de color:", self.color_mode_combo)
        ...
        <p><b>⚠️ Nota:</b> Mayor resolución = archivos más grandes y procesamiento más lento.</p>
        """)
        ...
        self.preview_btn = QtWidgets.QPushButton("👁️ Vista Previa")
    ...
    def load_pdf_info(self):
        ...
        try:
            if 'fitz' in sys.modules:
                ...
                pages = convert_from_path(self.pdf_path, dpi=72, first_page=1, last_page=1)
            ...
            self.pdf_info_label.setText(f"⚠️ Error: {str(e)}")
    ...
    def get_color_mode(self):
        ...
        return "RGB" if "RGB" in mode_text else "Grayscale"

    def get_application_category(self):
        """Obtener categoría de aplicación seleccionada"""
        category_text = self.application_category_combo.currentText()
